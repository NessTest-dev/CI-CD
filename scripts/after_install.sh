...
echo 'cd /home/ec2-user/CI-CD' >> /home/ec2-user/nodejs-aws-codedeploy-pipeline/deploy.log
cd /home/ec2-user/CI-CD >> /home/ec2-user/nodejs-aws-codedeploy-pipeline/deploy.log
